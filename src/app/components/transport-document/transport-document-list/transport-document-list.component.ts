...
export class TransportDocumentListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['number', 'type', 'amount', 'issuedate', 'paymentforecast', 'paymentstatus', 'paymentdate', 'actions'];
  dataSource = new MatTableDataSource<TransportDocument>(this.transportDocuments);
